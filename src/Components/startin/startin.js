...
const Startin = () => {
    ...
    return (
        <div>
            ...
            <p id="day" className="absolute text boder" style={{ height: 126 * ratio, width: 142 * ratio, fontSize: 80 * ratio, top: 2150 * ratio, left: 546 * ratio }}>2</p>
            <p id="daytext" className="absolute text boder" style={{ height: 35 * ratio, width: 142 * ratio, fontSize: 30 * ratio, top: 2240 * ratio, left: 545 * ratio }}>Day</p>
            <p id="hour" className="absolute text boder " style={{ height: 126 * ratio, width: 142 * ratio, fontSize: 80 * ratio, top: 2150 * ratio, left: 750 * ratio }}>3</p>
            <p id="hourtext" className="absolute text boder" style={{ height: 35 * ratio, width: 142 * ratio, fontSize: 30 * ratio, top: 2240 * ratio, left: 750 * ratio }}>Hour</p>
            <p id="minute" className="absolute text boder" style={{ height: 126 * ratio, width: 142 * ratio, fontSize: 80 * ratio, top: 2150 * ratio, left: 954 * ratio }}>3</p>
            <p id="minutetext" className="absolute text boder" style={{ height: 35 * ratio, width: 142 * ratio, fontSize: 30 * ratio, top: 2240 * ratio, left: 954 * ratio }}>Minute</p>
